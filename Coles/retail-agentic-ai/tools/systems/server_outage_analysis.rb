# CARINA Server Outage Analysis Tools
# Rationalized from: server-outage-impact_tools.rb
# Category: Systems
# Description: Tools for analyzing server outages and their business impact

module CARINA
  module Systems
    class ServerOutageAnalysis
