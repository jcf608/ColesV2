# CARINA Expiring Products Tools
# Rationalized from: expiring-soon_tools.rb
# Category: Retail
# Description: Tools for monitoring products approaching expiration dates

module CARINA
  module Retail
    class ExpiringProducts
